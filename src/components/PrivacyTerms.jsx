        ...
        {isPrivacyOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto border border-slate-200 text-left"
            ...
            >
              ...
              <div className="p-4 bg-slate-50 border-t border-slate-200 flex justify-end">
                <button
                  onClick={() => setIsPrivacyOpen(false)}
                  className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-6 rounded-xl text-xs cursor-pointer transition-colors"
                >
                  Close
                </button>
              </div>
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-4 text-slate-600 text-xs sm:text-sm font-light leading-relaxed">
                ...
                <h4 className="font-bold text-slate-800 pt-2 text-sm uppercase">1. Commercial Quotes</h4>
                <p>
                ...
                <h4 className="font-bold text-slate-800 pt-2 text-sm uppercase">2. Warranty Scope</h4>
                <p>
